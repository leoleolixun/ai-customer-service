...
- 支持英文/简体中文切换的最小管理后台、人工客服工作台和 JavaScript Widget
...
真实 Provider、性能、灾备、同一 Commit 的云端 CI 和 30 条人工复核已经通过；当前只剩独立 30 分钟
Widget 接入尚未完成，因此整版结论仍为“不通过”，不允许发布 `v1.0.0` Tag。
